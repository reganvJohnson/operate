...
public interface ConsigneeRepository extends CrudRepository<Module, Integer> {
...
//    List<Issue> findBySimpleQuery(String firstName);
    ...
    @Query("from Consignee where module_id=?1")
    ArrayList<Consignee> findByModuleId(Integer id);
}
